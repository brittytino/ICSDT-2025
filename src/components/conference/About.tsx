        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 max-w-6xl mx-auto">
            <div className="flex-shrink-0">
              <img src="/about.png" alt="About Conference" className="rounded-lg shadow-lg w-full md:w-96" />
            </div>
            <div className="flex-grow">
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-12">
                {topics.map((topic) => (
                  <span
                    key={topic}
                    className="px-4 py-2 bg-white rounded-full text-sm text-primary border border-primary/20 hover:bg-primary hover:text-white transition-colors"
                  >
                    {topic}
                  </span>
                ))}
