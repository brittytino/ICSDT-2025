...
const Submission = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section - Compact & Dark Gradient */}
      <div className="mt-16 w-full h-[120px] sm:h-[150px] md:h-[180px] flex items-center justify-center bg-gradient-to-r from-black to-[#c81616] shadow-lg">
